<%-- 
    ...
    Created on : 29 Feb, 2024, 6:11:16 AM
    Author     : Chetabist
--%>
...
//                    "<div class='subcandidate'>Who do you want to vote ?</div>"
//                    +"<div class='logout><a href='login.htlm'>logout</a></div>"
            StringBuffer displayBlock=new StringBuffer("<div class='sticky'><div class='candidate'>VOTE FOR CHANGE</div><br/>"+"<div class='subcandidate'>Whom do you want to vote ?</div><br/><br/>"+"<div class='logout'><a href='login.html'>logout</a></div></div>"
